...
/**
 * @title ERC1155BurnHarness
 * @notice Test harness that exposes ERC1155BurnMod's internal functions as external
 */
contract ERC1155BurnHarness {
    ...
    function balanceOf(address _account, uint256 _id) external view returns (uint256) {
        return BurnMod.getStorage().balanceOf[_id][_account];
    }
}
